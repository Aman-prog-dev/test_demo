...
UNIT_TEST(Signup_TEST)
{
    ...
    do
    {
        ...
        { // checking email contains @ and . or not
            count++;
        }
        i = i + 1;
    ...
    { // password must be greater than or equal to 8 and less than or equal to 12
        check++;
        ...
        do
        {
                     ...
                     && temp_password1[i] <= '9')
            {
                numbers = numbers + 1;
                     ...
                     || temp_password1[i] == '&' || temp_password1[i] == '#' || temp_password1[i] == '*')
            {
                special = special + 1;
            }
            i = i + 1;
